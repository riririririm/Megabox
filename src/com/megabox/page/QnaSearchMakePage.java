...
public class QnaSearchMakePage {
	private int perPage;
	private int curPage;
	private Search search;
	
	public QnaSearchMakePage(int curPage, int perPage, String kind, String search) {
	...
	public QnaSearchMakePage(int curPage, String kind, String search) {
		this(curPage, 5, kind, search);
	}
