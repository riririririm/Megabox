...
.boxoffice_num {
	...
	line-height: 2.3em;
	font-size: 1.2em;
	background-color: hsl(180, 100%, 30%, 0.8);
	color: white;
	text-align: center;
}
...
<script type="text/javascript">
	$(function() {
		...
		function getList() {
			$.get("./notice/noticeIndexList", function(data) {
				data = data.trim();
				$("#notice_list").html(data);	
			});
			
			$.get("./qna/qnaIndexList", function(data) {
				data = data.trim();
				$("#qna_list").html(data);	
			});
		}
	...
	<div class="container">
				...
				<div id="flip_box">
					<dl id="flip_dl">
								...
								<ul tabindex=0 id="movie_list1">
									...
									<c:forEach begin="1" end="4" var="i">
										<li class="box_movie">
											<div id="thumb_flip">
												<div class="upper">
													<span class="boxoffice_num"><strong> ${i }</strong>
													</span>
													<!-- number -->

													<div class="film_img1" id="box_poster${i }"></div>
													<!----- 영화 포스터 ------>
												...
												<div class="lower">
													<div class="back_wrap">
														<div id="starScore">
															<input type="image" src="#" alt="별점 1, 괜히 봤어요"
																title="별점 1, 괜히 봤어요"> &nbsp; <input
																type="hidden" name="score">
														</div>
														<p>평점</p>
														<button type="button">보고싶어</button>
													</div>
													<span class="bg"></span> <a href="#" class="blank"
														title="상세보기"> <span class="blind"> 상세보기 </span></a>
												</div>
												<!-- lower end -->
												...
												<div class="movie_info">
													<h3 class="film_box">
														<a href="#myModal${i }" data-toggle="modal"
															class="film_title1 film_title" id="box_title${i }"> </a>
														<!---- 영화 타이틀 ---->
													</h3>
													<!---------------- 버튼  ------------------>
													<div class="film_btn_wrap">
														<button class="film_btn btn btn-primary"
															title="film_detail" data-toggle="modal"
															data-target="#myModal${i }">상세정보</button>
														<button class="film_btn btn btn-primary" title="film_book"
						...
						<dd id="tab2">
							<p class="text-right">
								<a
									href="${pageContext.request.contextPath}/movieAPI/releaseMovie"
									id="movie_all2">최신 개봉작 전체보기 </a>
							</p>
							<div id="movie_slide2">
								<ul tabindex=0 id="movie_list2">
									<c:forEach begin="1" end="4" var="i">
										<li class="release_movie">
											<div id="thumb_flip">
												<div class="upper">
													<span class="boxoffice_num"><strong>${i }</strong> </span>
													<!-- number -->
													<div class="film_img2"></div>
													<!----- 영화 포스터 ------>
												</div>
												<div class="lower">
													<div class="back_wrap">
											...
											<div class="front_info">
												<div class="movie_info">
													<h3 class="film_box">
														<a href="#" class="film_title2 film_title"> </a>
														<!---- 영화 타이틀 ---->
													</h3>
													<div class="film_btn_wrap">
		...
		<div id="section2">
			<div id="section2_wrap">
				<div id="main_notice">
					<h3>
						공지사항 <a href="./notice/noticeList" id="plus"><img src="./images/plus.png"></a>
					</h3>
					<div id="notice_list">
				...
				<div id="main_qna">
					<h3>
						QNA <a href="./qna/qnaList" id="plus"><img src="./images/plus.png"></a>
					</h3>
		...
		<div class="modal fade" id="myModal${modal }" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
							...
							<div class="right_wrap">
								...
								<div class="modal_text_wrap">
									<div class="reservation_wrap">
										<p class="right_p">
										예매율 <strong>1</strong> 위 <span> %</span>
										</p>
									...
									<div class="review_write">
										...
										<div class="review_input">
											...
											<div class="review_area" id="code_hidden${modal }"
												title="movie_code"></div>
											<textarea class="write_textarea" id="contents"> </textarea>

											<div class="review_btn">
												<button type="button" id="writeCode${modal }"
													class="writeBtn btn btn-primary">등록</button>

											</div>
										</div>
									</div>
								</div>
								<!------------ modal_review_wrap end----------->
										...
										<div id="pager_wrap">
											<ul class="pager">
												<c:if test="${pager.curBlock gt 1}">
													<li class="previous"><a
														href="./reviewList?curPage=${pager.startNum-1}&reviewKind=${pager.search.communityKind}&search=${pager.search.search}">Previous</a></li>
												</c:if>
												<li>
													<ul class="pagination">
														<c:forEach begin="${pager.startNum}"
															...
															<li><a
																href="./reviewList?curPage=${i}&reviewKind=${pager.search.communityKind}&search=${pager.search.search}">${i}</a></li>
														</c:forEach>
												...
												<c:if test="${pager.curBlock lt pager.totalBlock}">
													<li class="next"><a
														href="./reviewList?curPage=${pager.lastNum+1}&reviewKind=${pager.search.communityKind}&search=${pager.search.search}">Next</a></li>
												</c:if>
											</ul>
										</div>
					...
					<button type="button" class="close" class="modal_close"
