			...
			<div class="user_wrap">
				...
				<div class="text" tabindex="0">
					<dl>
						...
						<dd>
							회사는 문의/접수 내역의 확인, 요청사항 처리 또는 완료시 원활한 의사소통 경로 확보를 위해 수집하고 있습니다
						</dd>
						<br>
						...
						<dd>문의접수 ~ 처리 완료 후 6개월<br>
						(단, 관계법령의 규정에 의하여 보존 할 필요성이 있는 경우에는 관계법령에 따라 보존)<br>
						자세한 내용은 개인정보 처리방침을 확인하시기 바랍니다.
						</dd>
					</dl>
				</div>
