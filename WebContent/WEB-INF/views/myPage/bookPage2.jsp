		...
		<div class="myPage">
			<div class="myPage_nav">
				<ul style="padding-left: 0px;">
					...
					<li><a href="${pageContext.request.contextPath}/member/myPersonalPage"><img src="../images/personal_info.PNG"></a></li>
					<li>
						<a href="./myQnA">
					...
					<div class="tab-content book_table">
						...
						<div id="reserve" class="tab-pane active">
							<table class="book_content table">
								...
								<c:if test="${bookList.size() eq null}">
								<tr>
									<td colspan="8" style="padding-top:130px; text-align: center; height: 300px;">최근 예매 내역이 없습니다.</td>
								</tr>
								</c:if> 
